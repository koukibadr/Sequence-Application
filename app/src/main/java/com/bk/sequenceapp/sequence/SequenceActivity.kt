...
class SequenceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*Displays an error message each time the ViewModel send an error via LiveData
        the live data sends a MessageType value, that will be transformed with the title() extension*/
        sequenceActivityVM.errorLiveData.observe(this) {errorMessage ->
            Toast.makeText(this,errorMessage.title(),Toast.LENGTH_SHORT).show()
        }

        /*
        Listen on final step data, when user reaches the final step a top view will be displayed with
        a Timer and text presents what is the button the user should click on
         */
        ...
        /*
        The timer live data observer, listen on the seconds generated by the {GenerateNumber} class
        the observer then start a timer.
         */
    ...
    /*
    triggered on pressing any button of the 3 step buttons "1", "2" and "3" buttons
    Linked to the buttons recycler view adapter
     */
